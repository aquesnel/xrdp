                                   ...
                                   tui32 completion_id)
{
    ...
    LOGM((LOG_LEVEL_DEBUG, "device_id=%d path=\"%s\""
                           ...
                           tui32 to_set)
{
    ...
    if ((irp = devredir_irp_with_pathname_new(filename)) != NULL)
    {
        ...
        LOGM((LOG_LEVEL_DEBUG, "lookup for device_id=%d path=%s",
                     ...
                     const char *path, int mode)
{
    ...
    LOGM((LOG_LEVEL_DEBUG, "device_id=%d path=%s mode=0%o", device_id, path, mode));
                         ...
                         const char *new_name)
{
    ...
    LOGM((LOG_LEVEL_DEBUG, "device_id=%d old_name=%s new_name=%s",
