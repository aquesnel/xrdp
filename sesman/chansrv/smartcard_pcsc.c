...
get_uds_client_by_id(int uds_client_id)
{
    ...
    if (uds_client_id == 0)
    {
        LOG_DEVEL(LOG_LEVEL_DEBUG, "get_uds_client_by_id: uds_client_id zero");
        return 0;
    }
    if (g_uds_clients == 0)
    {
        LOG_DEVEL(LOG_LEVEL_DEBUG, "get_uds_client_by_id: g_uds_clients is nil");
        return 0;
    }
    ...
    LOG_DEVEL(LOG_LEVEL_DEBUG, "get_uds_client_by_id: can't find uds_client_id %d",
           uds_client_id);
    return 0;
}
                          ...
                          tui32 app_card, struct pcsc_context **acontext)
{
    ...
    LOG_DEVEL(LOG_LEVEL_DEBUG, "get_pcsc_card_by_app_card:");
    LOG_DEVEL(LOG_LEVEL_DEBUG, "  app_card %d", app_card);
    if (uds_client == 0)
    {
        LOG_DEVEL(LOG_LEVEL_INFO, "get_pcsc_card_by_app_card: error");
        return 0;
    }
    if (uds_client->contexts == 0)
    {
                       ...
                       char *context, int context_bytes)
{
    ...
    if (pcscContext == 0)
    {
        LOG_DEVEL(LOG_LEVEL_INFO, "uds_client_add_context: error");
        return 0;
    }
    g_autoinc++;
                          ...
                          struct pcsc_context *acontext)
{
    ...
    if (uds_client->contexts == 0)
    {
        LOG_DEVEL(LOG_LEVEL_INFO, "uds_client_remove_context: error");
        return 1;
    }
                 ...
                 char *card, int card_bytes)
{
    ...
    if (pcscCard == 0)
    {
        LOG_DEVEL(LOG_LEVEL_INFO, "context_add_card: error");
        return 0;
    }
    g_autoinc++;
...
scard_pcsc_check_wait_objs(void)
{
    ...
    if (g_lis != 0)
    {
        ...
        {
            LOG_DEVEL(LOG_LEVEL_INFO, "scard_pcsc_check_wait_objs: g_lis trans_check_wait_objs error");
        }
    }
    if (g_uds_clients != 0)
    {
                                        ...
                                        int len, int status)
{
    ...
    if (uds_client == 0)
    {
        LOG_DEVEL(LOG_LEVEL_INFO, "scard_function_establish_context_return: "
    ...
    if (status == 0)
    {
        ...
        if (context_bytes > 16)
        {
            LOG_DEVEL(LOG_LEVEL_INFO, "scard_function_establish_context_return: opps "
...
scard_process_release_context(struct trans *con, struct stream *in_s)
{
    ...
    if (lcontext == 0)
    {
        LOG_DEVEL(LOG_LEVEL_INFO, "scard_process_release_context: "
                                      ...
                                      int len, int status)
{
    ...
    if (uds_client == 0)
    {
        LOG_DEVEL(LOG_LEVEL_INFO, "scard_function_release_context_return: "
               "get_uds_client_by_id failed");
        return 1;
    }
    con = uds_client->con;
...
scard_process_list_readers(struct trans *con, struct stream *in_s)
{
    ...
    {
        LOG_DEVEL(LOG_LEVEL_INFO, "scard_process_list_readers: Unreasonable string length %u",
                   bytes_groups);
        return 1;
    }
    ...
    if (lcontext == 0)
    {
        LOG_DEVEL(LOG_LEVEL_INFO, "scard_process_list_readers: "
               "get_pcsc_context_by_app_context failed");
        g_free(groups);
        return 1;
    }
                                   ...
                                   int len, int status)
{
    ...
    {
        LOG_DEVEL(LOG_LEVEL_INFO, "scard_function_list_readers_return: "
...
scard_process_connect(struct trans *con, struct stream *in_s)
{
    ...
    if (lcontext == 0)
    {
        LOG_DEVEL(LOG_LEVEL_INFO, "scard_process_connect: "
               "get_pcsc_context_by_app_context failed");
        return 1;
    }
                              ...
                              int len, int status)
{
    ...
    if (uds_client == 0)
    {
        LOG_DEVEL(LOG_LEVEL_INFO, "scard_function_connect_return: "
               "get_uds_client_by_id failed");
        return 1;
    }
    con = uds_client->con;
...
scard_process_disconnect(struct trans *con, struct stream *in_s)
{
    ...
    {
        LOG_DEVEL(LOG_LEVEL_INFO, "scard_process_disconnect: "
                                 ...
                                 int len, int status)
{
    ...
    if (uds_client == 0)
    {
        LOG_DEVEL(LOG_LEVEL_INFO, "scard_function_disconnect_return: "
               "get_uds_client_by_id failed");
        return 1;
    }
    con = uds_client->con;
...
scard_process_begin_transaction(struct trans *con, struct stream *in_s)
{
    ...
    {
        LOG_DEVEL(LOG_LEVEL_INFO, "scard_process_begin_transaction: "
               "get_pcsc_card_by_app_card failed");
        return 1;
    }
                                        ...
                                        int len, int status)
{
    ...
    if (uds_client == 0)
    {
        LOG_DEVEL(LOG_LEVEL_INFO, "scard_function_begin_transaction_return: "
               "get_uds_client_by_id failed");
        return 1;
    }
    con = uds_client->con;
...
scard_process_end_transaction(struct trans *con, struct stream *in_s)
{
    ...
    if ((lcard == 0) || (lcontext == 0))
    {
        LOG_DEVEL(LOG_LEVEL_INFO, "scard_process_end_transaction: "
               "get_pcsc_card_by_app_card failed");
        return 1;
    }
                                      ...
                                      int len, int status)
{
    ...
    if (uds_client == 0)
    {
        LOG_DEVEL(LOG_LEVEL_INFO, "scard_function_end_transaction_return: "
               "get_uds_client_by_id failed");
        return 1;
    }
    con = uds_client->con;
...
scard_process_transmit(struct trans *con, struct stream *in_s)
{
    ...
    if ((lcard == 0) || (lcontext == 0))
    {
        LOG_DEVEL(LOG_LEVEL_INFO, "scard_process_transmit: "
               "get_pcsc_card_by_app_card failed");
        return 1;
    }
                               ...
                               int len, int status)
{
    ...
    if (uds_client == 0)
    {
        LOG_DEVEL(LOG_LEVEL_INFO, "scard_function_transmit_return: "
               "get_uds_client_by_id failed");
        return 1;
    }
    con = uds_client->con;
...
scard_process_control(struct trans *con, struct stream *in_s)
{
    ...
    if ((lcard == 0) || (lcontext == 0))
    {
        LOG_DEVEL(LOG_LEVEL_INFO, "scard_process_control: "
               "get_pcsc_card_by_app_card failed");
        return 1;
    }
                              ...
                              int len, int status)
{
    ...
    if (uds_client == 0)
    {
        LOG_DEVEL(LOG_LEVEL_INFO, "scard_function_control_return: "
               "get_uds_client_by_id failed");
        return 1;
    }
    con = uds_client->con;
...
scard_process_status(struct trans *con, struct stream *in_s)
{
    ...
    if ((lcard == 0) || (lcontext == 0))
    {
        LOG_DEVEL(LOG_LEVEL_INFO, "scard_process_status: "
               "get_pcsc_card_by_app_card failed");
        return 1;
    }
                             ...
                             int len, int status)
{
    ...
    if (pcscStatus == 0)
    {
        LOG_DEVEL(LOG_LEVEL_INFO, "scard_function_status_return: pcscStatus is nil");
        return 1;
    }
    ...
    if (uds_client == 0)
    {
        LOG_DEVEL(LOG_LEVEL_INFO, "scard_function_status_return: "
               "get_uds_client_by_id failed");
        g_free(pcscStatus);
        return 1;
    }
    ...
    if (status == 0)
    {
        ...
        if (dwReaderLen < 1)
        {
            LOG_DEVEL(LOG_LEVEL_INFO, "scard_function_status_return: dwReaderLen < 1");
            dwReaderLen = 1;
        }
        if (dwReaderLen > 99)
        {
            LOG_DEVEL(LOG_LEVEL_INFO, "scard_function_status_return: dwReaderLen too big "
                   "0x%8.8x", dwReaderLen);
            dwReaderLen = 99;
        }
        g_memset(reader_name, 0, sizeof(reader_name));
...
scard_process_get_status_change(struct trans *con, struct stream *in_s)
{
    ...
    {
        LOG_DEVEL(LOG_LEVEL_INFO, "scard_process_get_status_change: bad cReaders %d", cReaders);
        return 1;
    }
    ...
    if (lcontext == 0)
    {
        LOG_DEVEL(LOG_LEVEL_INFO, "scard_process_get_status_change: "
               "get_pcsc_context_by_app_context failed");
        g_free(rsa);
        return 1;
    }
                                        ...
                                        int len, int status)
{
    ...
    if (uds_client == 0)
    {
        LOG_DEVEL(LOG_LEVEL_INFO, "scard_function_get_status_change_return: "
               "get_uds_client_by_id failed");
        return 1;
    }
    con = uds_client->con;
...
scard_process_cancel(struct trans *con, struct stream *in_s)
{
    ...
    if (lcontext == 0)
    {
        LOG_DEVEL(LOG_LEVEL_INFO, "scard_process_cancel: "
               "get_pcsc_context_by_app_context failed");
        return 1;
    }
                             ...
                             int len, int status)
{
    ...
    if (uds_client == 0)
    {
        LOG_DEVEL(LOG_LEVEL_INFO, "scard_function_cancel_return: "
               "get_uds_client_by_id failed");
        return 1;
    }
    con = uds_client->con;
...
scard_process_msg(struct trans *con, struct stream *in_s, int command)
{
    ...
    switch (command)
    {
        case 0x01: /* SCARD_ESTABLISH_CONTEXT */
            LOG_DEVEL(LOG_LEVEL_DEBUG, "scard_process_msg: SCARD_ESTABLISH_CONTEXT");
            rv = scard_process_establish_context(con, in_s);
            break;
        case 0x02: /* SCARD_RELEASE_CONTEXT */
            LOG_DEVEL(LOG_LEVEL_DEBUG, "scard_process_msg: SCARD_RELEASE_CONTEXT");
            rv = scard_process_release_context(con, in_s);
            break;

        case 0x03: /* SCARD_LIST_READERS */
            LOG_DEVEL(LOG_LEVEL_DEBUG, "scard_process_msg: SCARD_LIST_READERS");
            rv = scard_process_list_readers(con, in_s);
            break;

        case 0x04: /* SCARD_CONNECT */
            LOG_DEVEL(LOG_LEVEL_DEBUG, "scard_process_msg: SCARD_CONNECT");
        ...
        case 0x06: /* SCARD_DISCONNECT */
            LOG_DEVEL(LOG_LEVEL_DEBUG, "scard_process_msg: SCARD_DISCONNECT");
            rv = scard_process_disconnect(con, in_s);
            break;

        case 0x07: /* SCARD_BEGIN_TRANSACTION */
            LOG_DEVEL(LOG_LEVEL_DEBUG, "scard_process_msg: SCARD_BEGIN_TRANSACTION");
            rv = scard_process_begin_transaction(con, in_s);
            break;

        case 0x08: /* SCARD_END_TRANSACTION */
            LOG_DEVEL(LOG_LEVEL_DEBUG, "scard_process_msg: SCARD_END_TRANSACTION");
            rv = scard_process_end_transaction(con, in_s);
            break;

        case 0x09: /* SCARD_TRANSMIT */
            LOG_DEVEL(LOG_LEVEL_DEBUG, "scard_process_msg: SCARD_TRANSMIT");
            rv = scard_process_transmit(con, in_s);
            break;

        case 0x0A: /* SCARD_CONTROL */
            LOG_DEVEL(LOG_LEVEL_DEBUG, "scard_process_msg: SCARD_CONTROL");
            rv = scard_process_control(con, in_s);
            break;

        case 0x0B: /* SCARD_STATUS */
            LOG_DEVEL(LOG_LEVEL_DEBUG, "scard_process_msg: SCARD_STATUS");
            rv = scard_process_status(con, in_s);
            break;

        case 0x0C: /* SCARD_GET_STATUS_CHANGE */
            LOG_DEVEL(LOG_LEVEL_DEBUG, "scard_process_msg: SCARD_GET_STATUS_CHANGE");
            rv = scard_process_get_status_change(con, in_s);
            break;

        case 0x0D: /* SCARD_CANCEL */
            LOG_DEVEL(LOG_LEVEL_DEBUG, "scard_process_msg: SCARD_CANCEL");
        ...
        default:
            LOG_DEVEL(LOG_LEVEL_INFO, "scard_process_msg: unknown mtype 0x%4.4x", command);
            rv = 1;
            break;
    }
    return rv;
...
scard_pcsc_init(void)
{
    ...
    LOG_DEVEL(LOG_LEVEL_INFO, "scard_pcsc_init:");
    if (g_lis == 0)
    {
        ...
        if (g_directory_exist(g_pcsclite_ipc_dir))
        {
            ...
            {
                LOG_DEVEL(LOG_LEVEL_INFO, "scard_pcsc_init: g_remove_dir failed");
            }
        }
        if (!g_directory_exist(g_pcsclite_ipc_dir))
        {
            if (!g_create_dir(g_pcsclite_ipc_dir))
            {
                if (!g_directory_exist(g_pcsclite_ipc_dir))
                {
                    LOG_DEVEL(LOG_LEVEL_INFO, "scard_pcsc_init: g_create_dir failed");
                }
            }
        }
        ...
        if (error != 0)
        {
            LOG_DEVEL(LOG_LEVEL_INFO, "scard_pcsc_init: trans_listen failed for port %s",
                   g_pcsclite_ipc_file);
            return 1;
        }
    }
...
scard_pcsc_deinit(void)
{
    ...
    if (g_pcsclite_ipc_dir[0] != 0)
    {
        ...
        if (!g_remove_dir(g_pcsclite_ipc_dir))
        {
            LOG_DEVEL(LOG_LEVEL_INFO, "scard_pcsc_deinit: g_remove_dir failed");
        }
