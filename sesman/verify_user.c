...
auth_account_disabled(struct spwd *stp)
{
    ...
    LOG_DBG(LOG_LEVEL_DEBUG, "last   %ld", stp->sp_lstchg);
    LOG_DBG(LOG_LEVEL_DEBUG, "min    %ld", stp->sp_min);
    LOG_DBG(LOG_LEVEL_DEBUG, "max    %ld", stp->sp_max);
    LOG_DBG(LOG_LEVEL_DEBUG, "inact  %ld", stp->sp_inact);
    LOG_DBG(LOG_LEVEL_DEBUG, "warn   %ld", stp->sp_warn);
    LOG_DBG(LOG_LEVEL_DEBUG, "expire %ld", stp->sp_expire);
